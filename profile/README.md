...
- [ptaxsim :dollar:](https://github.com/ccao-data/ptaxsim) - Database and R package to analyze and estimate counterfactual Cook County property tax bills.
...
- [Assessor's Open Data :computer:](https://datacatalog.cookcountyil.gov/stories/s/gzdr-q7c4) - Catalog of public datasets including assessed values, property characteristics, appeals, permits, and more.
- [Data Dashboards :bar_chart:](https://www.cookcountyassessoril.gov/dashboard) - Visualizations with downloadable data to track assessed value changes, housing markets, and affordable housing.
